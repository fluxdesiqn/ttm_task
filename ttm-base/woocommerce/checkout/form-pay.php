	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', '_themename' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', '_themename' ); ?></th>
			</tr>
		</thead>
		<tbody>
