				...
				<main class="site-main" id="main">
					...
					<section class="error-404 not-found">
						...
						<div class="page-content">
							...
							<?php if ( ttm_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
							...
							$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', '_themename' ), convert_smilies( ':)' ) ) . '</p>';
